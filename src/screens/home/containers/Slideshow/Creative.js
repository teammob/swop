...
class SlideshowCreative extends React.Component {
  ...
  render() {
    ...
    const widthImage =
      fields.width && parseInt(fields.width) ? parseInt(fields.width) : 375;
    const heightImage =
      fields.height && parseInt(fields.height) ? parseInt(fields.height) : 390;
                  ...
                  {item.enable_button && (
                    <View style={styles.button}>
                      <Text
                        ...
                        style={[
                          styles.titleButton,
                          item.btn_name && item.btn_name.style,
                        ]}>
                        {item.btn_name &&
                        item.btn_name.text &&
